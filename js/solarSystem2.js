...
SolarSystemApp.prototype.init = function(container){
    ...
    var stars = new Stars();
    //添加星星
    stars.init(Sun.SIZE_IN_EARTHS+SolarSystemApp.EARTH_DISTANCE*SolarSystemApp.PLUTO_DISTANCE_IN_EARTH);
...
SolarSystemApp.PLUTO_DISTANCE_IN_EARTH = 77.2;
